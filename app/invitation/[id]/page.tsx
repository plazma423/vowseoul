                  ...
                  <div className="space-y-6 z-10 w-full max-w-[280px] mx-auto">
                    ...
                    {heroStyle === 'left' ? (
                      <div className="space-y-4 text-left px-4 w-full">
                        <div className="space-y-1">
                          {invitation.groomParentRelation && (
                            <p className="text-xs font-serif opacity-75">{invitation.groomParentRelation}</p>
                          )}
                          <h1 className="text-3xl font-serif font-light tracking-wide">
                            {invitation.groomName}
                          </h1>
                        </div>
                        <div className="text-xl font-serif font-light opacity-60" style={{ color: accentColor }}>&amp;</div>
                        <div className="space-y-1">
                          {invitation.brideParentRelation && (
                            <p className="text-xs font-serif opacity-75">{invitation.brideParentRelation}</p>
                          )}
                          <h1 className="text-3xl font-serif font-light tracking-wide">
                      ...
                      <div className="space-y-4 text-center w-full">
                        <h1 className="text-4xl font-serif font-light tracking-widest uppercase">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="text-xl font-serif font-light opacity-60 font-light" style={{ color: accentColor }}>&amp;</div>
                        <div className="space-y-1">
                          {invitation.brideParentRelation && (
                            <p className="text-xs font-serif opacity-75">{invitation.brideParentRelation}</p>
                          )}
                  ...
                  <Card className={cn("border-0 shadow-none", effectiveCardBg)} style={borderStyle}>
                    <CardContent className="p-6">
                      <div className="text-center mb-4">
                        <p className="text-2xl font-serif font-semibold" style={{ color: accentColor }}>{calMonth}</p>
                  ...
                  <Card className={cn("border-0", effectiveCardBg, shadowClass)} style={borderStyle}>
                    <CardContent className="p-6 text-left space-y-4">
                      <div>
                        ...
                        {invitation.venueHall && <p className="text-sm font-serif" style={{ color: accentColor }}>{invitation.venueHall}</p>}
                        <p className="text-xs opacity-60 mt-1">{invitation.venueAddress}</p>
                      </div>
                        ...
                        <div className="space-y-4 pt-4 border-t border-gray-100/10 text-xs">
                          {invitation.trafficInfo && (
                            <div>
                              ...
                              <p className="opacity-60 whitespace-pre-line mt-1 leading-relaxed">{invitation.trafficInfo}</p>
                            </div>
                          )}
                          {invitation.parkingInfo && (
                            <div>
                              <p className="font-semibold">주차 안내</p>
                              <p className="opacity-60 whitespace-pre-line mt-1 leading-relaxed">{invitation.parkingInfo}</p>
                            </div>
                          )}
                        </div>
                      )}
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            <div className="text-left">
                              ...
                              <p className="text-xs opacity-60 mt-0.5">예금주: {account.accountHolder}</p>
                            </div>
                            <Button
                              variant="outline"
                              size="sm"
